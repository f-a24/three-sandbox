...
export default () => {
  ...
  (() => {
    ...
    elem.id = 'vertex-shader';
    elem.type = 'x-shader/x-vertex';
    elem.innerHTML = `
    uniform float time;
    void main()
    {
    ...
    `;
    document.body.insertBefore(elem, document.getElementById('WebGL-output'));
  })();

  // fragmentShader1Create
  (() => {
    const elem = document.createElement('script');
    elem.id = 'fragment-shader-1';
    elem.type = 'x-shader/x-fragment';
    elem.innerHTML = `
    ...
    document.body.insertBefore(
      elem,
      document.getElementById('vertex-shader').nextElementSibling
    );
  })();

  // fragmentShader2Create
  (() => {
    const elem = document.createElement('script');
    elem.id = 'fragment-shader-2';
    elem.type = 'x-shader/x-fragment';
    elem.innerHTML = `
    ...
    document.body.insertBefore(
      elem,
      document.getElementById('fragment-shader-1').nextElementSibling
    );
  })();

  // fragmentShader3Create
  (() => {
    const elem = document.createElement('script');
    elem.id = 'fragment-shader-3';
    elem.type = 'x-shader/x-fragment';
    elem.innerHTML = `
    uniform vec2 resolution;
    uniform float time;
    ...
    document.body.insertBefore(
      elem,
      document.getElementById('fragment-shader-2').nextElementSibling
    );
  })();

  // fragmentShader4Create
  (() => {
    const elem = document.createElement('script');
    elem.id = 'fragment-shader-4';
    elem.type = 'x-shader/x-fragment';
    elem.innerHTML = `
    uniform float time;
    uniform vec2 resolution;
    ...
    document.body.insertBefore(
      elem,
      document.getElementById('fragment-shader-3').nextElementSibling
    );
  })();

  // fragmentShader5Create
  (() => {
    const elem = document.createElement('script');
    elem.id = 'fragment-shader-5';
    elem.type = 'x-shader/x-fragment';
    elem.innerHTML = `
    uniform float time;
    uniform vec2 resolution;
    ...
    document.body.insertBefore(
      elem,
      document.getElementById('fragment-shader-4').nextElementSibling
    );
  })();

  // fragmentShader6Create
  (() => {
    const elem = document.createElement('script');
    elem.id = 'fragment-shader-6';
    elem.type = 'x-shader/x-fragment';
    elem.innerHTML = `
    uniform float time;
    uniform vec2 resolution;
    ...
    document.body.insertBefore(
      elem,
      document.getElementById('fragment-shader-5').nextElementSibling
    );
  })();
  ...
  const createMaterial = (vertexShader: string, fragmentShader: string) => {
